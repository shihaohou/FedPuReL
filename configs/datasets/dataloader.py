...
from datasets.long_tail import train_long_tail
...
def load_cifar10_LT_data(datadir, imb_factor, imb_type):
    ...
    img_num_list, list_label2indices_train_new = train_long_tail(copy.deepcopy(list_label2indices), 10, imb_factor, imb_type)
